...
ZelzalDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗵𝗲𝗼 - اوامــر المطـور المســاعد](t.me/Source_Theo ) .\n\n"
    ...
    "\n𓆩 [𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/Source_Theo ) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**⎉╎يتم الان اعـادة تشغيـل بـوت ثـيـو  انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗧𝗵𝗲𝗼 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**⎉╎يتم الان اعـادة تشغيـل بـوت ثـيـو  انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
