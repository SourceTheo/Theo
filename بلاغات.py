...
""" 
Abuse Notifications for Theo ™ t.me/Source_Theo 
Write file by Zelzal t.me/XIX_A
    ...
    if len(zed) == 2:
        ...
        for _ in range(counter):
            ...
            if event.reply_to_msg_id:
                ...
                await event.client.send_message('@AbuseNotifications', spam_message) # code by t.me/XIX_A 
        ...
        return
    if DelaySpam is not True: # code by t.me/XIX_A 
        if BOTLOG:
