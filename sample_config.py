...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Zilzalll/ZThon"
    )
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Theo ")
    # for custom thumb image set this with your required thumb telegraoh link
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg"
    )
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/SourceTheo/asist")
    if OLDZED_REPO and not url(OLDZED_REPO):
        OLDZED_REPO = "https://github.com/SourceTheo/asist"
