...
""" 
Logo & Style for Theo™ t.me/Source_Theo 
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/XIX_A
    ...
    if arabic_text: # code by t.me/XIX_A
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/XIX_A
