...
ZDEV = (6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @XIX_A\
                                  \n\n--------بـدء تتبـع سجـل ثـيـو 𝗧𝗵𝗲𝗼--------\
                        ...
                        link = "[𐇮  𝐌𝐀𝐑𝐂𝐄𝐋𝐎 𐇮](https://t.me/XIX_A)"
                        text = (
                            "**✘ تقـريـر اشعـار ثـيـو 𝗧𝗵𝗲𝗼 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ثـيـو 𝗧𝗵𝗲𝗼 ✘**\n\n "
                        link = "[𐇮 𝐌𝐀𝐑𝐂𝐄𝐋𝐎 𐇮](https://t.me/XIX_A)"
