# Marcelo 
# Copyright (C) 2023 Marcelo . All Rights Reserved
#
# This file is a part of < https://github.com/SourceTheo/Theo/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/SourceTheo/Theo/blob/main/LICENSE/>.
"""سـورس ثـيـو ™
So تخمـط الملـف اهينك واطشك للناس خماط واوثق عليك
Copyright (C) 2023 Marcelo . All Rights Reserved
Credit: https://github.com/SourceTheo/Theo
Devloper: https://t.me/XIX_A -  مرسليو """
"""import json
import math
import asyncio
import os
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:  # Code by T.me/XIX_A
        malathid = Config.OWNER_ID
    elif query_user_id == user_id or query_user_id == int(user_id):
        malathid = user_id
    if query_user_id == Config.OWNER_ID or query_user_id == user_id or query_user_id == int(user_id) or query_user_id in Config.SUDO_USERS:  # Code by T.me/XIX_A
