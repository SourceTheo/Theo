...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/Source_Theo   ) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/Source_Theo ) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
**⎉╎قـائمـة اوامـر السـوبـر (النشـر العـام) الخاصـه بـ سـورس ثـيـو  ♾ :**
...
ٴ┄─┄─┄─┄┄─┄─┄─┄─┄┄
**⪼ مـلاحظــات هـامــه :**
- اوامـر السوبـرات إضـافة جديـدة خاصـه وحصريـه بسـورس ثـيـو ¹ فقـط ...
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/Source_Theo ) .
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/Source_Theo ) .
**- الامـر :**
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
                ...
                [
                    ...
                    Button.inline("ثـيـو ", data="zedvr"),
                ],
                [
...
**- الوصـف :**
لـ عـرض تاريـخ بـدء تنصيبك على سـورس ثـيـو 
...
**- الوصـف :**
لـ عـرض اوامـر الاذاعـه الخاصـه بسـورس ثـيـو 
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
**- ملاحظـه :**
هـذا الامـر حصـري فقط وخاص بـ سـورس ثـيـو  بقية السورسات ماتحمـل دقـة HD ؟!
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تحميـل الكتب 📕](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.كتاب`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر بحـث تيليـجـرام 🛰](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.تلي` **+ كلمـة**

**- الوصـف :**
امـر ممطـروق وحصريـاً ع سـورس ثـيـو  فقـط
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/Source_Theo ) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.بلاي`
**العــاب الانـلايـن لســورس ثـيـو  🕹**
**⪼** `.كت`
**اسئلـة كـت تـويت ⁉️**
**⪼** `.كت`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/Source_Theo ) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/Source_Theo ) .
**⪼** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/Source_Theo ) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
**- مثـال :**
`.اختصار https://github.com/SourceTheo/Theo`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/Source_Theo ) .
**- الامـر :**
...
**- ملاحظـه :**
سـورس ثـيـو هو اول من كتب فكرة الاشتراك الاجباري واضافها للسورس كـ فكرة جديدة لسورسات تيليثون
الملف كان مدفوع وتم تنزيله مجاني
تـاريـخ كتابـة الملـف - 30 اكتوبر/2022 
 https://t.me/Source_Theo
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & الـتثبيت ❇️](t.me/Source_Theo ) .
...
**- انضـم للقنـاة ~ @UU_OG**
**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن ثـيـو **
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝗧𝗵𝗲𝗼 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/Source_Theo ) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
