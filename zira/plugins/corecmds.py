...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "بالـرد ع اي ملف (يدعم سورس ثـيـو) لـ تنصيبه في بوتك.",
...
async def install(event):
    ...
    zed_dev = (6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993)
