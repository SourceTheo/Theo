...
ZelzalVP_cmd = (
    "𓆩 [𝗧𝗵𝗲𝗼  𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/Source_Theo) 𓆪\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @UU_OG \n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @UU_OG\n\n"
    ...
    "\n𓆩 [𝗧𝗵𝗲𝗼  𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/UU_OG ) 𓆪"
)
...
async def variable(event):
    ...
    # All Rights Reserved for "Zed-Thon" "مرسليو  "
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**⎉╎تم حـذف {} بنجـاح ☑️**\n**⎉╎المتغيـر المحـذوف : ↶**\n `{}` \n**⎉╎يتم الان اعـادة تشغيـل بـوت ثـيـو  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @Source_Theo**".format(input_str, variable))
...
async def variable(event):
    ...
    viran = "Asia/Tehran"
    heroku_var = app.config()
    zed = await edit_or_reply(event, "**⎉╎جـاري أعـداد المنطقـه الزمنيـه لـ ثـيـو  🌐...**")
    # All Rights Reserved for "Zed-Thon" "مرسليو  "
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**⎉╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @Source_Theo**".format(input_str, vinfo))
