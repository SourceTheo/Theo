...
""" 
CC Checker & Generator for Theo™ t.me/Source_Theo 
Write file by Marcelo t.me/XIX_A
hhh o ya beby
...
async def song2(event):
    ...
    chat = "@SDBB_Bot" # code by t.me/XIX_A
...
async def song2(event): # code by t.me/XIX_A
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by t.me/XIX_A
    chat = "@SDBB_Bot" # code by t.me/XIX_A
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by t.me/XIX_A 
    chat = "@SDBB_Bot" # code by t.me/XIX_A 
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by t.me/XIX_A 
    chat = "@SDBB_Bot" # code by t.me/XIX_A 
    reply_id_ = await reply_id(event)
