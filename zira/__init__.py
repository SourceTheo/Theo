...
__version__ = "3.3.2"
__license__ = "حقـوق سـورس ثـيـو "
__author__ = "ثـيـو <https://T.me/Source_Theo >"
__copyright__ = "Theo Source (C) 2020 - 2024  " + __author__

zedub.version = __version__
LOGS = logging.getLogger("ثـيـو ")
bot = zedub
...
if Config.UPSTREAM_REPO == "zel":
    UPSTREAM_REPO_URL = "https://github.com/SourceTheo/Theo"
else:
