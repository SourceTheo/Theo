...
Zed_Vip = (6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993, 6367618993)
zchannel = {"@Source_Theo ", "@PP_UF", "@PP_5U", "@PP_U5", "@PP_9U", "@UU_O1", "@UU_OG", "@Source_Theo", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo ", "@Source_Theo "}
...
async def autovars(): #Code by T.me/XIX_A
...
async def autoname(): #Code by T.me/XIX_A
...
async def mybot(): #Code by T.me/XIX_A
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "Theo ")
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت ثـيـو المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ثـيـو الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝙏𝙝𝙚𝙤𓅛", "https://t.me/Source_Theo "),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "جروب السجـل ثـيـو ", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            "جروب التخـزين", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
